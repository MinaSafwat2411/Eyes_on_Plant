...
import '../../routes.dart';
import 'cubit/vegetables_states.dart';
...
class VegetablesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var cubit = context.read<VegetablesCubit>();
    return BlocConsumer<VegetablesCubit, VegetablesStates>(
      builder:
                  ...
                  ListView.separated(
                    itemBuilder:
                        (context, index) => GestureDetector(
                          onTap: () {
                            context.pushNamed(AppRoutes.vegetablesDetails.name,extra: cubit.vegetables[index]);
                          },
                          child: Stack(
                    ...
                    itemCount: cubit.vegetables.length,
                    shrinkWrap: true,
