...
class VegetablesDetailsScreen extends StatelessWidget {
  const VegetablesDetailsScreen({super.key,required this.vegetable});
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        vegetable.growingConditions?.watering??"",
                        style: TextStyle(
                          color: const Color(0xFF3C3D37),
                          fontSize: 14,
                          fontFamily: 'Poppins',
                      ...
                      Text(
                        vegetable.growingConditions?.sunlight??"",
                        style: TextStyle(
                          color: const Color(0xFF3C3D37),
                          fontSize: 14,
                          fontFamily: 'Poppins',
                      ...
                      Text(
                        vegetable.growingConditions?.soil??"",
                        style: TextStyle(
                          color: const Color(0xFF3C3D37),
                          fontSize: 14,
                          fontFamily: 'Poppins',
                      ...
                      Text(
                        vegetable.growingConditions?.temperature??"",
                        style: TextStyle(
                          color: const Color(0xFF3C3D37),
                          fontSize: 14,
                          fontFamily: 'Poppins',
                      ...
                      Text(
                        vegetable.growingConditions?.growingSeason??"",
                        style: TextStyle(
                          color: const Color(0xFF3C3D37),
                          fontSize: 14,
                          fontFamily: 'Poppins',
                      ...
                      Text(
                        vegetable.growingConditions?.plantingTips??"",
                        style: TextStyle(
                          color: const Color(0xFF3C3D37),
                          fontSize: 14,
                          fontFamily: 'Poppins',
                      ...
                      Table(
                        ...
                        children: [
                          ...
                          TableRow(children: [
                            Text(
                              vegetable.characteristics?.fruit??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                            ...
                            Text(
                              vegetable.characteristics?.colorShape??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                            ...
                            Text(
                              vegetable.characteristics?.flavor??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                            ...
                            Text(
                              vegetable.characteristics?.flowers??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                          ...
                          TableRow(children: [
                            Text(
                              vegetable.characteristics?.plant??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                            ...
                            Text(
                              vegetable.characteristics?.size??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                            ...
                            Text(
                              vegetable.characteristics?.foliage??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
                            ...
                            Text(
                              vegetable.characteristics?.varieties??"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: const Color(0xFF3C3D37),
                                fontSize: 16,
